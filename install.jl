...
# ╔═╡ ae9478d2-cf17-4fbf-8c37-c9c0450dab54
begin
...
# ╔═╡ 08083680-23be-4e35-b0e7-b0e6d0e86620
html"""
<div style="
position: absolute;
width: calc(100% - 30px);
...
# ╔═╡ 573e0639-9752-44e3-9200-949e0520e664
md"""
# Bem vindo!
...
# ╔═╡ be853e64-b6c1-4458-8da5-106bf7e17012
html"""
<head>
    <style>
    {
...
<div class="row">
        <div class="column";">
            ...
            <ol>
				...
				<li>Construir um modelo geometalúrgico</li>
			</ol>
        </div>
        <div class="column";">
...
# ╔═╡ 63c8d6a0-6c4c-44ea-9a57-af809610c8be
md"""
## Instalação de software 💻

Neste minicurso utilizaremos **softwares 100% gratuitos** para construir um modelo geometalúrgico 3D com **dados reais da indústria**. Isso significa que você poderá usar o que aprender aqui para sempre, sem precisar de uma licença de software 😉

Se já chegou até aqui, é porque conseguiu instalar a linguagem de programação [Julia](https://docs.julialang.org/en/v1) com sucesso 👏🏽 Também conseguiu instalar o sistema de notebooks [Pluto](https://plutojl.org), que usaremos no minicurso para tornar a experiência de aprendizado mais interativa.

Este notebook que você está lendo realiza a instalação de alguns **pacotes** necessários para os nossos objetivos. Teremos a chance de aprender mais sobre esses pacotes no minicurso:
"""

# ╔═╡ 93ba103e-c4d1-4799-9655-080c19f5af82
import GeoStats

# ╔═╡ 366b1cb1-1dcc-465b-ab59-ee7e90667732
import DrillHoles

# ╔═╡ d54d87e7-5bb2-4c49-97e3-54fef04089c2
import CSV

# ╔═╡ 9216ba12-edca-4655-af25-543eb3bc7c6f
import CairoMakie

# ╔═╡ da14ecd2-1463-4682-9130-5d880d4d2931
import PairPlots

# ╔═╡ 7fc3cff1-5ed7-41a3-a530-e27b20a61a4d
md"""
Por enquanto, basta saber que as células acima fazem o download e instalam os pacotes na sua máquina nas versões que precisamos. Esse processo pode levar tempo dependendo da sua conexão de internet e das especificações do seu hardware.

Se tudo correr bem, você verá marcadores de sucesso ao lado de cada pacote, como na figura abaixo:

![install](https://i.imgur.com/rEzC6lx.png)
"""

# ╔═╡ 0d766b46-f9df-462b-948a-7f81ee7d74c4
md"""
Estamos ansiosos para conhecê-los. Até breve!
...
git-tree-sha1 = "77b6d5bef681f19e4e1fd3a886d7a1b519650200"
