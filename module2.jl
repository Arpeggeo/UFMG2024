...
# ╔═╡ 2b3303b7-79b9-41a8-a576-0d05be19e49e
begin
...
# ╔═╡ f3ed44a1-4998-4aab-8f28-cf87811824e0
using DrillHoles

# ╔═╡ cef6589e-14bd-4dca-9a7c-11751afe9ad3
using CSV
...
# ╔═╡ 4281fc54-b60f-405e-baa5-ae78d1ee2414
begin
	scored1 = false
	if ismissing(survey)
		still_missing()
...
# ╔═╡ 52cd094c-bb3a-463b-abec-2036beecd62c
hint(md"Leia a mensagem de erro com atenção, ela tem dicas importantes...")
...
# ╔═╡ 3a28714a-f9b8-4e73-b570-69dfdb9e8bf5
begin
	scored2 = false
...
# ╔═╡ 75fe66cd-c611-41d5-99d3-b3ee68cd87e4
begin
	scored3 = false
...
A [Arpeggeo®](https://arpeggeo.tech) desenvolve o framework, e constroe soluções avançadas utilizando essas ferramentas abertas. Entre em contato conosco caso precise de uma solução customizada para os desafios de geometalurgia na sua empresa: [contact@arpeggeo.tech](mailto:contact@arpeggeo.tech)
"""
